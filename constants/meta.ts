...
export const meta: Metadata = {
    ...
    description:
        "A Full-Stack Developer based in Southern California. I help transform businesses ideas into tangible full scale application. ",
    keywords: [
        "HTML",
        "CSS",
        "JavaScript",
    ...
    icons: {
        icon: [
            { url: "/favicon.ico" },
            new URL("/favicon.ico", "https://jkdelara.com"),
        ],
