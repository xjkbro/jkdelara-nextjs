...
export default async function handler(req: NextApiRequest, res: NextApiResponse<string>) {
    const noteURL = 'https://cms.jsondelara.com/api/posts?fields[0]=id&fields[1]=slug';
    const notesURL = 'https://cms.jsondelara.com/api/categories?fields[0]=id&fields[1]=slug';
    const projectsURL = 'https://cms.jsondelara.com/api/projects?fields[0]=id&fields[1]=slug';
