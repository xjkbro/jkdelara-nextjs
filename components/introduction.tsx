    ...
    return (
        <>
            <motion.div
                ...
                <div id="home-avatar" className="mx-auto my-8 w-[300px] h-[300px]  md:order-2 order-1" >
                    <AnimatedBorder><Image className="mx-auto bg-transparent rounded-full" src="/feature.png" priority width={300} height={300} alt="Photo of Jason Kyle De Lara" /></AnimatedBorder>
                </div>
            </motion.div>
