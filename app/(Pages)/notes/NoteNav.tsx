            ...
            >
                {
                    Object.entries(navLinks).map(([path, { name }], i) => {
                        ...
                        return (
                            <Link href={path} key={i} className={clsx("underline-hover-effect text-xl font-light hover:text-sixth", { '!text-sixth before:!absolute before:!bottom-0 before:!left-0 before:!w-full before:!content-[""] before:!h-[2px] before:!bg-eighth': isActive, })}>{name}</Link>
